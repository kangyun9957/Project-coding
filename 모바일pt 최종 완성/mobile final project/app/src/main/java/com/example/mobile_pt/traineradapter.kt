...
class traineradapter (val context: Context, val trainerList: ArrayList<trainerdata>, val itemClick: (trainerdata) -> Unit) :

    RecyclerView.Adapter<traineradapter.Holder>() {
